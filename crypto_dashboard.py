...
# Uncomment below code in 2nd part of the session
...
# Uncomment below code in 3rd part of the session
...
# Part 4: Metrics
#Uncomment below code in 4th part of the session
...
#Uncomment below code in 5th part of the session
